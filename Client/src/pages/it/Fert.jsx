...
const Fert = () => {
  const { Fertilizers, BuyerOfProduct, Connect } = UseContractProvider();
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const productData = await Fertilizers();
        setProducts(productData);
      } catch (error) {
        console.log("Error fetching products. Please try again later." ,error);
      } finally {
        setLoading(false);
      }
    };
